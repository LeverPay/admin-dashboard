  ...
  return (
    <div className="remittances-container rounded-[20px]">
      ...
      <div className="revenue-section  gap-2">
        <div className="w-full lg:w-[206px] h-[88px] bg-white rounded-[10px] border border-blue-600 p-2">
          ...
          <div className="revenue-data flex items-center justify-between">
            <h2 className="w-full lg:w-[142.44px] h-[23.66px] text-blue-950 text-base font-bold leading-[20px]">
              319
            </h2>{' '}
